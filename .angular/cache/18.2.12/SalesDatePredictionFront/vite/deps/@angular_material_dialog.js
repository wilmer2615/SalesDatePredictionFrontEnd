...
var _MatDialogContainerBase = class extends CdkDialogContainer {
...
_MatDialogContainerBase.ɵfac = function _MatDialogContainerBase_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatDialogContainerBase)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(FocusTrapFactory), ɵɵdirectiveInject(DOCUMENT, 8), ɵɵdirectiveInject(MatDialogConfig), ɵɵdirectiveInject(InteractivityChecker), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(OverlayRef), ɵɵdirectiveInject(FocusMonitor));
};
_MatDialogContainerBase.ɵcmp = ɵɵdefineComponent({
...
MatDialogContainer.ɵfac = function MatDialogContainer_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || MatDialogContainer)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(FocusTrapFactory), ɵɵdirectiveInject(DOCUMENT, 8), ɵɵdirectiveInject(MatDialogConfig), ɵɵdirectiveInject(InteractivityChecker), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(OverlayRef), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(FocusMonitor));
};
MatDialogContainer.ɵcmp = ɵɵdefineComponent({
  ...
  hostBindings: function MatDialogContainer_HostBindings(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      ɵɵsyntheticHostProperty("@dialogContainer", ctx._getAnimationState());
      ɵɵattribute("aria-modal", ctx._config.ariaModal)("role", ctx._config.role)("aria-labelledby", ctx._config.ariaLabel ? null : ctx._ariaLabelledBy)("aria-label", ctx._config.ariaLabel)("aria-describedby", ctx._config.ariaDescribedBy || null);
    }
  },
  features: [ɵɵInheritDefinitionFeature],
  decls: 1,
...
_MatDialogBase.ɵfac = function _MatDialogBase_Factory(__ngFactoryType__) {
  ɵɵinvalidFactory();
};
_MatDialogBase.ɵprov = ɵɵdefineInjectable({
...
MatDialog.ɵfac = function MatDialog_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || MatDialog)(ɵɵinject(Overlay), ɵɵinject(Injector), ɵɵinject(Location, 8), ɵɵinject(MAT_DIALOG_DEFAULT_OPTIONS, 8), ɵɵinject(MAT_DIALOG_SCROLL_STRATEGY), ɵɵinject(MatDialog, 12), ɵɵinject(OverlayContainer), ɵɵinject(ANIMATION_MODULE_TYPE, 8));
};
...
MatDialogClose.ɵfac = function MatDialogClose_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || MatDialogClose)(ɵɵdirectiveInject(MatDialogRef, 8), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(MatDialog));
};
...
MatDialogTitle.ɵfac = function MatDialogTitle_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || MatDialogTitle)(ɵɵdirectiveInject(MatDialogRef, 8), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(MatDialog));
};
...
MatDialogContent.ɵfac = function MatDialogContent_Factory(__ngFactoryType__) {
...
MatDialogActions.ɵfac = function MatDialogActions_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || MatDialogActions)();
};
MatDialogActions.ɵdir = ɵɵdefineDirective({
  ...
  hostBindings: function MatDialogActions_HostBindings(rf, ctx) {
    if (rf & 2) {
      ɵɵclassProp("mat-dialog-actions-align-center", ctx.align === "center")("mat-dialog-actions-align-end", ctx.align === "end");
    }
  },
  inputs: {
    align: "align"
...
MatDialogModule.ɵfac = function MatDialogModule_Factory(__ngFactoryType__) {
